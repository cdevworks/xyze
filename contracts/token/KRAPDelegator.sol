...
import "./KRAPDelegate.sol";

contract KRAPDelegator is KRAPTokenInterface, KRAPDelegatorInterface {
    /**
     * @notice Construct a new KRAP
    ...
    function _setImplementation(address implementation_, bool allowResign, bytes memory becomeImplementationData) public {
        require(msg.sender == gov, "KRAPDelegator::_setImplementation: Caller must be gov");
    ...
    function () external payable {
        require(msg.value == 0,"KRAPDelegator:fallback: cannot send value to fallback");
